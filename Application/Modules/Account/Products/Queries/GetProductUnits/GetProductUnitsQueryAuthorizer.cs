...
public class GetProductUnitsQueryAuthorizer : AuthorizationHandler<ZetaAuthorizationRequirement<GetProductUnitsQuery>>
{
    private readonly UserManager<TenantUser> _userManager;
    private readonly ITenantDbContext _context;

    public GetProductUnitsQueryAuthorizer(UserManager<TenantUser> userManager, ITenantDbContext context)
    {
    ...
    protected override async Task HandleRequirementAsync(
        ...
        ZetaAuthorizationRequirement<GetProductUnitsQuery> requirement)
    {
