...
public class PurchaseInvoiceItemDto
{
    ...
    private class Mapping : Profile
    {
        public Mapping()
        {
            CreateMap<Novologs.Domain.Entities.LocalizedString, LocalizedStringItemDto>();

            CreateMap<Novologs.Domain.Entities.Product, ProductSummaryDto>()
                .ForMember(d => d.Value,            opt => opt.MapFrom(s => s.Name.Value))
                .ForMember(d => d.LocalizedStrings, opt => opt.MapFrom(s => s.Name.LocalizedStrings));

            CreateMap<Novologs.Domain.Entities.PurchaseInvoiceItem, PurchaseInvoiceItemDto>()
