...
public class RemoveLeadMemberCommandAuthorizer : AuthorizationHandler<ZetaAuthorizationRequirement<RemoveLeadMemberCommand>>
{
    private readonly ITenantDbContext _context;
    private readonly IUser _user;
    private readonly UserManager<TenantUser> _userManager;

    public RemoveLeadMemberCommandAuthorizer(
    ...
    protected override async System.Threading.Tasks.Task HandleRequirementAsync(
        ...
        ZetaAuthorizationRequirement<RemoveLeadMemberCommand> requirement)
    {
        ...
        context.Fail(new AuthorizationFailureReason(this, "Only the lead creator or members with ManageMembers permission can remove members."));
    }
}
