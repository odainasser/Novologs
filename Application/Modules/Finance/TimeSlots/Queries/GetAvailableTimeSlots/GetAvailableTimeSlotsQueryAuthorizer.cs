...
public class
    GetAvailableTimeSlotsQueryAuthorizer : AuthorizationHandler<
    ZetaAuthorizationRequirement<GetAvailableTimeSlotsQuery>>
{
    private readonly IUser _user;
    private readonly UserManager<TenantUser> _userManager;
    private readonly ITenantDbContext _context;

    public GetAvailableTimeSlotsQueryAuthorizer(
    ...
    protected override async System.Threading.Tasks.Task HandleRequirementAsync(
        ...
        ZetaAuthorizationRequirement<GetAvailableTimeSlotsQuery> requirement)
    {
        ...
        if (! hasPermission)
        {
            context.Fail(new AuthorizationFailureReason(this, "User is not authorized to read available time slots."));
            return;
        }
        else
        {
