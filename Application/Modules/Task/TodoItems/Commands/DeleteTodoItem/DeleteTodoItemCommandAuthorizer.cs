...
public class DeleteTodoItemCommandAuthorizer : AuthorizationHandler<ZetaAuthorizationRequirement<DeleteTodoItemCommand>>
{
    private readonly IUser _user;
    private readonly UserManager<TenantUser> _userManager;
    private readonly ITenantDbContext _context;
    
    public DeleteTodoItemCommandAuthorizer(
    ...
    protected override async System.Threading.Tasks.Task HandleRequirementAsync(AuthorizationHandlerContext context,
        ZetaAuthorizationRequirement<DeleteTodoItemCommand> requirement)
    {
        ...
        if (! hasPermission)
        {
            context.Fail(new AuthorizationFailureReason(this, "User is not authorized to delete todo item."));
            return;
        }
        else
        {
            ...
            {
                context.Fail(new AuthorizationFailureReason(this, "User is not authorized to delete this todo item."));
            }
        }
    }
}
