...
public class
    UpdateRolePermissionCommandAuthorizer : AuthorizationHandler<
    ZetaAuthorizationRequirement<UpdateRolePermissionCommand>>
{
    private readonly UserManager<TenantUser> _userManager;
    private readonly IUser _user;
    private readonly ITenantDbContext _context;

    public UpdateRolePermissionCommandAuthorizer(
    ...
    protected override async System.Threading.Tasks.Task HandleRequirementAsync(
        ...
        ZetaAuthorizationRequirement<UpdateRolePermissionCommand> requirement
    )
    {
        var hasPermission =
        ...
        if (!hasPermission)
        {
            context.Fail(new AuthorizationFailureReason(this, "User is not authorized to update role permission."));
            return;
        }
