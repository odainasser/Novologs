...
public class
    GetAllRolesUserCommandAuthorizer : AuthorizationHandler<ZetaAuthorizationRequirement<GetAllRolesUserCommand>>
{
    private readonly UserManager<TenantUser> _userManager;
    private readonly ITenantDbContext _context;
    private readonly ITenantPolicyService _tenantPolicyService;

    public GetAllRolesUserCommandAuthorizer(UserManager<TenantUser> userManager, ITenantDbContext context, ITenantPolicyService tenantPolicyService)
    {
    ...
    protected override async System.Threading.Tasks.Task HandleRequirementAsync(
        ...
        ZetaAuthorizationRequirement<GetAllRolesUserCommand> requirement
    )
    {
        ...
        if (!hasPermission)
        {
            context.Fail(new AuthorizationFailureReason(this, "User is not authorized to get all roles user."));
            return;
        }
        else
        {
