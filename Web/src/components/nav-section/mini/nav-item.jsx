          ...
          const eventMappings = [
            {
              paths: [
                ...
                '/dashboard/ticketing/list',
              ],
              event: 'reset-project-view',
            },
            {
              paths: ['/dashboard/client/list', '/dashboard/vendor/list'],
              event: 'reset-client-view',
            },
            { paths: ['/dashboard/user/list'], event: 'reset-user-view' },
            { paths: ['/dashboard/kanban/list'], event: 'reset-kanban-view' },
          ];

          for (const { paths, event } of eventMappings) {
      ...
      >
        ...
        {title && (
          <Box
            ...
            sx={{
              ...(storedLang === 'ar' ? { fontSize: '0.75rem !important' } : {}),
            }}
          >
            {title}
          </Box>
