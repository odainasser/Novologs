...
export function Upload({
  ...
  className,
  multiple = false,
  loading = false, // Loading state to control spinner
  ...other
}) {
  ...
  const hasFile = value instanceof File || typeof value === 'string'; // ✅ more accurate
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* If uploading, show the CircularProgress spinner in the center */}
        {loading ? (
      ...
      {/* Render the multi-file preview when it's not uploading */}
      {!loading && renderMultiPreview}
    </Box>
  );
}
