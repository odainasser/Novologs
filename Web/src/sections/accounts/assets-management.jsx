...
import { AssetsManagementTableRow } from './assets-management-table-row';
...
import { mock_assets, mock_posted_voucher } from './account-mock-data';
...
export function AssetsManagement({
  ...
  const TABLE_HEAD = [
    ...
    {
      id: 'asset',
      label: t('tasks.asset_name'),
      width: '50%',
      align: storedLang === 'ar' ? 'right' : 'left',
    },
    {
      id: 'date',
      label: t('tasks.date_of_purchase'),
      width: '20%',
      align: storedLang === 'ar' ? 'right' : 'left',
    },
    {
