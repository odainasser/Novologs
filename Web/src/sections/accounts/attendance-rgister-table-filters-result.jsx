...
export function AttendanceRegisterFiltersResult({ filters, onResetPage, totalResults, sx }) {
  const handleRemoveStatus = useCallback(() => {
    onResetPage();
    filters.setState({ status: 'All Timesheets' }); 
  }, [filters, onResetPage]);

  const handleRemoveProject = useCallback(() => {
    onResetPage();
    filters.setState({ project: 'All Projects' });
  }, [filters, onResetPage]);
