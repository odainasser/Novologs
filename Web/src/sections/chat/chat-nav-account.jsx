...
export function ChatNavAccount({ onlineUsers }) {
      ...
      <Badge
        ...
        sx={{
          ...
          [`& .${badgeClasses.badge}`]: {
            ...
            bottom: 0,
            right: 0,
            bgcolor: isOnline ? '#00C853' : 'gray',
            color: isOnline ? '#00C853' : 'gray',
            boxShadow: '0 0 0 2px white',
          },
        }}
      >
        <Avatar
          src={user?.profileImageFileUrl}
          alt={user?.fullName}
