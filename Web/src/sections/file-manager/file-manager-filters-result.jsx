...
export function FileManagerFiltersResult({ filters, onResetPage, totalResults, sx }) {
  ...
  return (
    <FiltersResult totalResults={totalResults} onReset={handleReset} sx={sx}>
      ...
      <FiltersBlock label="Project:" isShow={!!filters.state.projectName}>
  <Chip
    {...chipProps}
    label={filters.state.projectName}
    onDelete={() => {
      onResetPage();
      filters.setState({ projectName: '' });
    }}
  />
</FiltersBlock>
<FiltersBlock label="Client:" isShow={!!filters.state.clientName}>
  <Chip
    {...chipProps}
    label={filters.state.clientName}
    onDelete={() => {
      onResetPage();
      filters.setState({ clientName: '' });
    }}
  />
</FiltersBlock>
