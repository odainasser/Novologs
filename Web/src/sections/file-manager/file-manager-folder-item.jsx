...
// import { FileManagerFileDetails } from './file-manager-file-details-drawer';
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title=  {t('files.buttons.delete')}
        content= {t('files.dialog.delete_content')}
        action={
